export const homeContent = {
  ...
  whyChoose: {
    ...
    images: [
      {
        src: "/why_choose_us_3.png",
        alt: "Ophthalmologist performing an eye examination",
        variant: "large",
      },
      {
        src: "/why_choose_2.jpg",
        alt: "Namokar Eye specialist team",
        variant: "top",
      },
      {
  ...
  treatmentVideo: {
    ...
    sparkle: {
      src: "/assets/Home/why-choice-sparkle.png",
      alt: "",
      width: 36,
      height: 38,
    },
  ...
  stats: {
    ...
    heart: {
      src: "/assets/Home/stats-heart.png",
      alt: "",
      width: 62,
      height: 58,
    },
  ...
  doctorsAppointment: {
    ...
    appointment: {
      ...
      submitLabel: "Book Appointment Now",
      fields: {
